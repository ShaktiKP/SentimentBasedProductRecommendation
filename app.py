			  ...
			  <div class="row vstack gap-3">
				<div class="row">
				  <div class="col-sm-5">
					...
					/>
					<p>
					  <small>Enter usernames like "08dallas","02dakota", "123charlie" etc. </small>
					</p>
				  </div>
				  <div class="col-sm-2">
...
def prediction():
    ...
    if(not(items is None)):
        ...
        return render_template_string(html_template, column_names=items.columns.values, row_data=list(items.values.tolist()), zip=zip)
    else:
        return render_template_string(html_template, message="User Name doesn't exists, No product recommendations at this point of time!")
...
def predict_sentiment():
    ...
    return render_template_string(html_template, sentiment=pred_sentiment)
