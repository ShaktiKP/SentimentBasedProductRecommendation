...
Solution
github link: https://github.com/ShaktiKP/SentimentBasedProductRecommendation#
...
• Machine Learning models are saved in the pickle files(under the pickle); Flask API (app.py) is used to interface and test the Machine Learning models. Bootstrap and Flask jinja templates are used for setting up the User interface.The html code is embeded within the flask app.py file using render_template_string. No additional Custom Styles used.
